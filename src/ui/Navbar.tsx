              ...
              {menuItems.map((item) => {
                ...
                return (
                  <li key={item.name}>
                    <Link
                      href={item.href}
                      className={`inline-flex items-center text-lg font-semibold px-2  hover:underline underline-offset-4 dark:hover:text-indigo-500 hover:text-indigo-400 transition-all ease-in-out duration-150 ${isActive
